    ...
    <div className="relative border-2 border-gray-200 rounded-md overflow-hidden">
      ...
      <div className="p-5">
        ...
        <Link to={`/tutions/${tution._id}`}>
          <h1 className="font-[500] text-lg cursor-pointer hover:text-hover_color">
            {tution.Title}
          </h1>
        </Link>
        {tution?.Rating ? (
      ...
      <div className="border-t-2 border-gray-200">
        <div className="px-5 ">
          <p className="float-right text-text_color_secondary_2 py-2">
            Starting at:{" "}
            <span className="text-lg font-bold text-text_color_secondary">
              PKR {tution.Fee}
            </span>
          </p>
        </div>
