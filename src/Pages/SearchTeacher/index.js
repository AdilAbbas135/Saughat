  ...
  return (
    <div>
      ...
      <div className="w-full mb-10">
        <div className="hidden md:block bg-main_color_2 py-2 pb-5 px-5 ">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl mb-1 font-semibold">Filter Teachers</h2>
            <div className="mt-2 grid grid-cols-5 gap-x-2">
              ...
              <button className=" py-2 px-4 bg-hover_color text-white font-bold rounded-md w-full">
                Filter
              </button>
            </div>
          </div>
        </div>
        <div className="list-container max-w-7xl m-auto  relative">
          <div className="mt-5 w-full grid grid-cols-1 px-3 xl:px-5 2xl:px-0  md:grid-cols-2 gap-x-3 gap-y-3">
            {!loading &&
  ...
  return (
    <div className="relative border-2 border-gray-300 w-full flex flex-col tablets:flex-row items-center space-x-4 p-2">
      ...
      <div className="flex flex-col w-full space-y-2">
        ...
        {/* <span className="text-sm my-2">123 mm from center</span> */}
