...
const AddFood = () => {
  ...
  const AddTution = async () => {
    ...
    Data.append("Items", JSON.stringify(Subjects));
    await axios
      .post(`${process.env.REACT_APP_BACKEND_URL}/hall-manager/addFood`, Data, {
        headers: { token: token },
      })
      .then((result) => {
        console.log(result);
        ...
        navigate("/user/hall-manager/food");
      })
      .catch((err) => {
        console.log(err);
        setaddLoading(false);
    ...
    <div className="mb-10">
      ...
      >
        ...
        <ul className="list-disc ml-10">
          {Errors.SubjectError && (
            <li>Must Select At least 1 Food to Continue </li>
          )}
        ...
        <div className="bg-white p-10 rounded-md shadow-sm grid grid-cols-1 gap-x-5 gap-y-5">
          ...
          <div className="col-span-1">
            <div className="flex items-center justify-between">
              ...
              {Errors.SubjectError && (
                <p className="text-red-500 italic">Must Select 1 item</p>
              )}
            </div>
            <div
